...
% I. Setup the GA
ff='smalllights'; % objective function
npar=2; % number of optimization variables
varhi=20; varlo=-20; % variable limits
%_______________________________________________________
...
%_______________________________________________________
% III. GA parameters
popsize= a; % set population size
mutrate= b; % set mutation rate
...
while iga<maxit
    ...
    % second offspring
    %__________________________0.1_____________________________
